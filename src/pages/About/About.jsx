    ...
    <section className="about-us-section">
      <div className="about-container">
        ...
        <div className="section-block">
          <h3 className="section-title">Aarohi'26</h3>
          <div className="section-content">
            <p>
              Aarohi'26 is the official cultural event of our institution,
        ...
        <div className="vision-mission-grid">
          <div className="vision-mission-card">
            ...
            <h4>Our Vision</h4>
            <p>
              Aarohi'26 aspires to be a transformative cultural-technical
          ...
          <div className="vision-mission-card">
            ...
            <h4>Our Mission</h4>
            <p>
              Aarohi'26 is dedicated to fostering holistic growth by providing a
